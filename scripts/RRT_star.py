### Differene between RRT and RRT*:
## Additionally, RRT* optimizes the path by checking for better connections to nearby nodes and re-wiring the tree.
...
class RRT:
    ...
    def near(self, new_node):
        ...
        radius = tuning_constant * (math.log(n) / n)**(1/2) 
...
def main():
    ...
    video_output = create_video(filename="../media/RRT_star_Traversal.mp4")
