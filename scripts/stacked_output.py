...
caps = [
    ...
    cv2.VideoCapture("../media/RRT_star_Traversal.mp4"),
    cv2.VideoCapture("../media/RRT_star_N_Traversal.mp4"),
]
...
# Output writer
out = cv2.VideoWriter("../media/stacked_output.mp4", fourcc, fps, (width, height * len(caps)))
